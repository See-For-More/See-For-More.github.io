    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        ...
        <address class="navbar-text">
          623 Coral St. San Agustin, Iriga City, Camarines Sur
        </address>
            ...
            <div class="wrapper">
              ...
              <div class="portfolio-card" data-reveal>
                ...
                <figure class="card-banner img-holder has-before" style="--width: 700; --height: 605;">
                  <img src="./assets/images/portfolio-1.jpg" width="700" height="605" loading="lazy" alt="𝗔𝗠𝗔𝗞𝗔𝗕𝗢𝗚𝗘𝗥𝗔 𝗔𝗻 𝗟𝗚𝗕𝗧𝗤𝗜𝗔+ 𝗧𝗿𝗶𝗯𝘂𝘁𝗲 𝗳𝗼𝗿 𝗪𝗼𝗺𝗲𝗻"
                    class="img-cover">
                </figure>

                <div class="card-content">
                  <h3 class="h4">
                    <a href="https://www.facebook.com/ChriShotssss/posts/pfbid0v6psuLaQjRtjyLWGhUsbjt4TAiXzNYa2kjr9FR2edfS19fzAzWrBBhRNpFVwhWUdl" class="card-title">𝗔𝗠𝗔𝗞𝗔𝗕𝗢𝗚𝗘𝗥𝗔 𝗔𝗻 𝗟𝗚𝗕𝗧𝗤𝗜𝗔+ 𝗧𝗿𝗶𝗯𝘂𝘁𝗲 𝗳𝗼𝗿 𝗪𝗼𝗺𝗲𝗻</a>
                  </h3>

                  <p class="card-tag">Event Photography</p>
                </div>

                <a href="https://www.facebook.com/ChriShotssss/posts/pfbid0v6psuLaQjRtjyLWGhUsbjt4TAiXzNYa2kjr9FR2edfS19fzAzWrBBhRNpFVwhWUdl" class="btn-icon" aria-label="See more">
                  <svg xmlns="http://www.w3.org/2000/svg" width="43" height="20" viewBox="0 0 43 20" fill="none">
              ...
              <div class="portfolio-card" data-reveal>
                ...
                <figure class="card-banner img-holder has-before" style="--width: 700; --height: 1000;">
                  <img src="./assets/images/portfolio-3.jpg" width="700" height="1000" loading="lazy" alt="Estela & Carmelito 50Th Wedding Anniversary"
                    class="img-cover">
                </figure>

                <div class="card-content">
                  <h3 class="h4">
                    <a href="https://www.facebook.com/ChriShotssss/posts/pfbid09hKmDpfNzX7D3wdEzsKXb1jpxd65fq7CXwqRXEPA5ZygZipqnFiN5etZEjK9zikrl" class="card-title">Estela & Carmelito 50Th Wedding Anniversary</a>
                  </h3>

                  <p class="card-tag">Wedding Photography</p>
                </div>

                <a href="https://www.facebook.com/ChriShotssss/posts/pfbid09hKmDpfNzX7D3wdEzsKXb1jpxd65fq7CXwqRXEPA5ZygZipqnFiN5etZEjK9zikrl" class="btn-icon" aria-label="See more">
                  <svg xmlns="http://www.w3.org/2000/svg" width="43" height="20" viewBox="0 0 43 20" fill="none">
                    <path d="M0 10H41" stroke="black" stroke-width="2" />
                    <path d="M33 1L41.9 10.2727L33 19" stroke="black" stroke-width="2" />
                  </svg>
            ...
            <div class="wrapper">
              ...
              <div class="portfolio-card" data-reveal>
                ...
                <figure class="card-banner img-holder has-before" style="--width: 700; --height: 1091;">
                  <img src="./assets/images/portfolio-2.jpg" width="700" height="1091" loading="lazy" alt="Prinson Israel Dedication & 1st Birthday Highlights"
                    class="img-cover">
                </figure>

                <div class="card-content">
                  <h3 class="h4">
                    <a href="https://www.facebook.com/ChriShotssss/videos/945487650559557" class="card-title">Prinson Israel Dedication & 1st Birthday Highlights</a>
                  </h3>

                  <p class="card-tag">Film Maker, Christening Photography</p>
                </div>

                <a href="https://www.facebook.com/ChriShotssss/videos/945487650559557" class="btn-icon" aria-label="See more">
                  <svg xmlns="http://www.w3.org/2000/svg" width="43" height="20" viewBox="0 0 43 20" fill="none">
                    <path d="M0 10H41" stroke="black" stroke-width="2" />
                    <path d="M33 1L41.9 10.2727L33 19" stroke="black" stroke-width="2" />
                  </svg>
              ...
              <div class="portfolio-card" data-reveal>
                ...
                <figure class="card-banner img-holder has-before" style="--width: 700; --height: 850;">
                  <img src="./assets/images/portfolio-4.png" width="700" height="850" loading="lazy" alt="Liberata 28's birthday Photoshoot"
                    class="img-cover">
                </figure>

                <div class="card-content">
                  <h3 class="h4">
                    <a href="https://www.facebook.com/ChriShotssss/videos/414090121132259" class="card-title">Liberata 28's birthday Photoshoot</a>
                  </h3>

                  <p class="card-tag">Film, Birthday Photography</p>
                </div>

                <a href="https://www.facebook.com/ChriShotssss/videos/414090121132259" class="btn-icon" aria-label="See more">
                  <svg xmlns="http://www.w3.org/2000/svg" width="43" height="20" viewBox="0 0 43 20" fill="none">
                    <path d="M0 10H41" stroke="black" stroke-width="2" />
                    <path d="M33 1L41.9 10.2727L33 19" stroke="black" stroke-width="2" />
                  </svg>
